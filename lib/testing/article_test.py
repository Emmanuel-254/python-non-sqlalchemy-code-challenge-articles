...
class TestArticle:
    ...
    def test_name_is_immutable_string(self):
        ...
        # Ensure the name cannot be modified after creation
        try:
            author_1.name = "ActuallyTopher"  # This should raise an exception
        except AttributeError:
            pass  # This is expected, name should not be changed
        else:
            assert False, "Author name should be immutable"
